...
// Use let so we can regenerate later
...
document.querySelector('.again').addEventListener('click', function () {
  score = 20;
  secretNumber = Math.trunc(Math.random() * 20) + 1; // ✅ Regenerate secret number
  ...
  document.querySelector('.guess').disabled = false; // ✅ Re-enable input field
});
